...
public:
  ConfigureVec() {
    ParameterVariantVec = std::vector<rclcpp::parameter::ParameterVariant> ({
      ...
      rclcpp::parameter::ParameterVariant("edit.output_pixfmt","{'enum': [{'type': 'str', 'srcfile': 'Tutorials.cfg', 'name': 'out_RGB8', 'description': '', 'cconsttype': 'const char * const', 'value': 'RGB8', 'srcline': 22, 'ctype': 'std::string'}, {'type': 'str', 'srcfile': 'Tutorials.cfg', 'name': 'out_BGR8', 'description': '', 'cconsttype': 'const char * const', 'value': 'BGR8', 'srcline': 23, 'ctype': 'std::string'}, {'type': 'str', 'srcfile': 'Tutorials.cfg', 'name': 'out_MONO8', 'description': '', 'cconsttype': 'const char * const', 'value': 'MONO8', 'srcline': 24, 'ctype': 'std::string'}], 'enum_description': 'An enum to set color encoding mode'}"),
      ...
      rclcpp::parameter::ParameterVariant("edit.image_rotation","{'enum': [{'type': 'int', 'srcfile': 'Tutorials.cfg', 'name': 'degree_0', 'description': '', 'cconsttype': 'const int', 'value': 0, 'srcline': 31, 'ctype': 'int'}, {'type': 'int', 'srcfile': 'Tutorials.cfg', 'name': 'degree_90', 'description': '', 'cconsttype': 'const int', 'value': 1, 'srcline': 32, 'ctype': 'int'}, {'type': 'int', 'srcfile': 'Tutorials.cfg', 'name': 'degree_counter90', 'description': '', 'cconsttype': 'const int', 'value': 3, 'srcline': 33, 'ctype': 'int'}, {'type': 'int', 'srcfile': 'Tutorials.cfg', 'name': 'degree_180', 'description': '', 'cconsttype': 'const int', 'value': 2, 'srcline': 34, 'ctype': 'int'}], 'enum_description': 'An enum to set image rotation degree'}"),
      ...
      rclcpp::parameter::ParameterVariant("edit.compressedformat","{'enum': [{'type': 'str', 'srcfile': 'Tutorials.cfg', 'name': 'JPEG', 'description': '', 'cconsttype': 'const char * const', 'value': 'JPEG', 'srcline': 27, 'ctype': 'std::string'}, {'type': 'str', 'srcfile': 'Tutorials.cfg', 'name': 'PNG', 'description': '', 'cconsttype': 'const char * const', 'value': 'PNG', 'srcline': 28, 'ctype': 'std::string'}], 'enum_description': 'An enum to set compressed fromat'}"),
      ...
      rclcpp::parameter::ParameterVariant("edit.trigger_source","{'enum': [{'type': 'str', 'srcfile': 'Tutorials.cfg', 'name': 'Software', 'description': '', 'cconsttype': 'const char * const', 'value': 'Software', 'srcline': 50, 'ctype': 'std::string'}, {'type': 'str', 'srcfile': 'Tutorials.cfg', 'name': 'Line0', 'description': '', 'cconsttype': 'const char * const', 'value': 'Line0', 'srcline': 51, 'ctype': 'std::string'}, {'type': 'str', 'srcfile': 'Tutorials.cfg', 'name': 'Line1', 'description': '', 'cconsttype': 'const char * const', 'value': 'Line1', 'srcline': 52, 'ctype': 'std::string'}, {'type': 'str', 'srcfile': 'Tutorials.cfg', 'name': 'Line2', 'description': '', 'cconsttype': 'const char * const', 'value': 'Line1', 'srcline': 53, 'ctype': 'std::string'}, {'type': 'str', 'srcfile': 'Tutorials.cfg', 'name': 'LIne3', 'description': '', 'cconsttype': 'const char * const', 'value': 'Line3', 'srcline': 54, 'ctype': 'std::string'}], 'enum_description': 'An enum to set source'}"),
      ...
      rclcpp::parameter::ParameterVariant("edit.trigger_selector","{'enum': [{'type': 'str', 'srcfile': 'Tutorials.cfg', 'name': 'AcquisitionStart', 'description': '', 'cconsttype': 'const char * const', 'value': 'AcquisitionStart', 'srcline': 57, 'ctype': 'std::string'}, {'type': 'str', 'srcfile': 'Tutorials.cfg', 'name': 'AcquisitionEnd', 'description': '', 'cconsttype': 'const char * const', 'value': 'AcquisitionEnd', 'srcline': 58, 'ctype': 'std::string'}, {'type': 'str', 'srcfile': 'Tutorials.cfg', 'name': 'AcquisitionActive', 'description': '', 'cconsttype': 'const char * const', 'value': 'AcquisitionActive', 'srcline': 59, 'ctype': 'std::string'}, {'type': 'str', 'srcfile': 'Tutorials.cfg', 'name': 'FrameStart', 'description': '', 'cconsttype': 'const char * const', 'value': 'FrameStart', 'srcline': 60, 'ctype': 'std::string'}, {'type': 'str', 'srcfile': 'Tutorials.cfg', 'name': 'FrameEnd', 'description': '', 'cconsttype': 'const char * const', 'value': 'FrameEnd', 'srcline': 61, 'ctype': 'std::string'}, {'type': 'str', 'srcfile': 'Tutorials.cfg', 'name': 'FrameActive', 'description': '', 'cconsttype': 'const char * const', 'value': 'FrameActive', 'srcline': 62, 'ctype': 'std::string'}, {'type': 'str', 'srcfile': 'Tutorials.cfg', 'name': 'FrameBurstStart', 'description': '', 'cconsttype': 'const char * const', 'value': 'FrameBurstStart', 'srcline': 63, 'ctype': 'std::string'}, {'type': 'str', 'srcfile': 'Tutorials.cfg', 'name': 'FrameBurstEnd', 'description': '', 'cconsttype': 'const char * const', 'value': 'FrameBurstEnd', 'srcline': 64, 'ctype': 'std::string'}, {'type': 'str', 'srcfile': 'Tutorials.cfg', 'name': 'FrameBurstActive', 'description': '', 'cconsttype': 'const char * const', 'value': 'FrameBurstActive', 'srcline': 65, 'ctype': 'std::string'}, {'type': 'str', 'srcfile': 'Tutorials.cfg', 'name': 'LineStart', 'description': '', 'cconsttype': 'const char * const', 'value': 'LineStart', 'srcline': 66, 'ctype': 'std::string'}, {'type': 'str', 'srcfile': 'Tutorials.cfg', 'name': 'ExposureStart', 'description': '', 'cconsttype': 'const char * const', 'value': 'ExposureStart', 'srcline': 67, 'ctype': 'std::string'}, {'type': 'str', 'srcfile': 'Tutorials.cfg', 'name': 'ExposureEnd', 'description': '', 'cconsttype': 'const char * const', 'value': 'ExposureEnd', 'srcline': 68, 'ctype': 'std::string'}, {'type': 'str', 'srcfile': 'Tutorials.cfg', 'name': 'ExposureActive', 'description': '', 'cconsttype': 'const char * const', 'value': 'ExposureActive', 'srcline': 69, 'ctype': 'std::string'}], 'enum_description': 'An enum to set tirgger behavior'}"),
      ...
      rclcpp::parameter::ParameterVariant("edit.trigger_activation","{'enum': [{'type': 'str', 'srcfile': 'Tutorials.cfg', 'name': 'RisingEdge', 'description': '', 'cconsttype': 'const char * const', 'value': 'RisingEdge', 'srcline': 72, 'ctype': 'std::string'}, {'type': 'str', 'srcfile': 'Tutorials.cfg', 'name': 'FallingEdge', 'description': '', 'cconsttype': 'const char * const', 'value': 'FallingEdge', 'srcline': 73, 'ctype': 'std::string'}, {'type': 'str', 'srcfile': 'Tutorials.cfg', 'name': 'AnyEdge', 'description': '', 'cconsttype': 'const char * const', 'value': 'AnyEdge', 'srcline': 74, 'ctype': 'std::string'}, {'type': 'str', 'srcfile': 'Tutorials.cfg', 'name': 'LevelHigh', 'description': '', 'cconsttype': 'const char * const', 'value': 'LevelHigh', 'srcline': 75, 'ctype': 'std::string'}, {'type': 'str', 'srcfile': 'Tutorials.cfg', 'name': 'LevelLow', 'description': '', 'cconsttype': 'const char * const', 'value': 'LevelLow', 'srcline': 76, 'ctype': 'std::string'}], 'enum_description': 'An enum to set tirgger activation method'}"),
      ...
      rclcpp::parameter::ParameterVariant("edit.trigger_overlap","{'enum': [{'type': 'str', 'srcfile': 'Tutorials.cfg', 'name': 'Off', 'description': '', 'cconsttype': 'const char * const', 'value': 'Off', 'srcline': 80, 'ctype': 'std::string'}, {'type': 'str', 'srcfile': 'Tutorials.cfg', 'name': 'ReadOut', 'description': '', 'cconsttype': 'const char * const', 'value': 'ReadOut', 'srcline': 81, 'ctype': 'std::string'}, {'type': 'str', 'srcfile': 'Tutorials.cfg', 'name': 'PreviousFrame', 'description': '', 'cconsttype': 'const char * const', 'value': 'PreviousFrame', 'srcline': 82, 'ctype': 'std::string'}, {'type': 'str', 'srcfile': 'Tutorials.cfg', 'name': 'PreviousLine', 'description': '', 'cconsttype': 'const char * const', 'value': 'PreviousLine', 'srcline': 83, 'ctype': 'std::string'}], 'enum_description': 'An enum to set tirgger overlap method'}"),
      ...
      rclcpp::parameter::ParameterVariant("edit.awb_lightprofile","{'enum': [{'type': 'str', 'srcfile': 'Tutorials.cfg', 'name': 'Indoor', 'description': '', 'cconsttype': 'const char * const', 'value': 'Indoor', 'srcline': 97, 'ctype': 'std::string'}, {'type': 'str', 'srcfile': 'Tutorials.cfg', 'name': 'Outdoor', 'description': '', 'cconsttype': 'const char * const', 'value': 'Outdoor', 'srcline': 98, 'ctype': 'std::string'}], 'enum_description': 'An enum to set light profile'}"),
      ...
      rclcpp::parameter::ParameterVariant("edit.ae_lightmode","{'enum': [{'type': 'str', 'srcfile': 'Tutorials.cfg', 'name': 'Normal', 'description': '', 'cconsttype': 'const char * const', 'value': 'Normal', 'srcline': 101, 'ctype': 'std::string'}, {'type': 'str', 'srcfile': 'Tutorials.cfg', 'name': 'Backlight', 'description': '', 'cconsttype': 'const char * const', 'value': 'Backlight', 'srcline': 102, 'ctype': 'std::string'}, {'type': 'str', 'srcfile': 'Tutorials.cfg', 'name': 'Frontlight', 'description': '', 'cconsttype': 'const char * const', 'value': 'Frontlight', 'srcline': 103, 'ctype': 'std::string'}], 'enum_description': 'An enum to set auto exposure lighting mode setting'}"),
      ...
      rclcpp::parameter::ParameterVariant("edit.ae_priority","{'enum': [{'type': 'str', 'srcfile': 'Tutorials.cfg', 'name': 'Gain', 'description': '', 'cconsttype': 'const char * const', 'value': 'Gain', 'srcline': 118, 'ctype': 'std::string'}, {'type': 'str', 'srcfile': 'Tutorials.cfg', 'name': 'ExposureTime', 'description': '', 'cconsttype': 'const char * const', 'value': 'ExposureTime', 'srcline': 119, 'ctype': 'std::string'}], 'enum_description': 'An enum to set auto exposure control priority setting'}"),
