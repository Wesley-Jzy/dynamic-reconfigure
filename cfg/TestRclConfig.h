...
public:
  ConfigureVec() {
    ParameterVariantVec = std::vector<rclcpp::parameter::ParameterVariant> ({
      ...
      rclcpp::parameter::ParameterVariant("edit.output_pixfmt","{'enum': [{'value': 'RGB8', 'srcline': 22, 'name': 'out_RGB8', 'srcfile': 'Tutorials.cfg', 'description': '', 'type': 'str', 'ctype': 'std::string', 'cconsttype': 'const char * const'}, {'value': 'BGR8', 'srcline': 23, 'name': 'out_BGR8', 'srcfile': 'Tutorials.cfg', 'description': '', 'type': 'str', 'ctype': 'std::string', 'cconsttype': 'const char * const'}, {'value': 'MONO8', 'srcline': 24, 'name': 'out_MONO8', 'srcfile': 'Tutorials.cfg', 'description': '', 'type': 'str', 'ctype': 'std::string', 'cconsttype': 'const char * const'}], 'enum_description': 'An enum to set color encoding mode'}"),
      ...
      rclcpp::parameter::ParameterVariant("edit.image_rotation","{'enum': [{'value': 0, 'srcline': 31, 'name': 'degree_0', 'srcfile': 'Tutorials.cfg', 'description': '', 'type': 'int', 'ctype': 'int', 'cconsttype': 'const int'}, {'value': 1, 'srcline': 32, 'name': 'degree_90', 'srcfile': 'Tutorials.cfg', 'description': '', 'type': 'int', 'ctype': 'int', 'cconsttype': 'const int'}, {'value': 3, 'srcline': 33, 'name': 'degree_counter90', 'srcfile': 'Tutorials.cfg', 'description': '', 'type': 'int', 'ctype': 'int', 'cconsttype': 'const int'}, {'value': 2, 'srcline': 34, 'name': 'degree_180', 'srcfile': 'Tutorials.cfg', 'description': '', 'type': 'int', 'ctype': 'int', 'cconsttype': 'const int'}], 'enum_description': 'An enum to set image rotation degree'}"),
      ...
      rclcpp::parameter::ParameterVariant("edit.compressedformat","{'enum': [{'value': 'JPEG', 'srcline': 27, 'name': 'JPEG', 'srcfile': 'Tutorials.cfg', 'description': '', 'type': 'str', 'ctype': 'std::string', 'cconsttype': 'const char * const'}, {'value': 'PNG', 'srcline': 28, 'name': 'PNG', 'srcfile': 'Tutorials.cfg', 'description': '', 'type': 'str', 'ctype': 'std::string', 'cconsttype': 'const char * const'}], 'enum_description': 'An enum to set compressed fromat'}"),
      ...
      rclcpp::parameter::ParameterVariant("edit.trigger_source","{'enum': [{'value': 'Software', 'srcline': 50, 'name': 'Software', 'srcfile': 'Tutorials.cfg', 'description': '', 'type': 'str', 'ctype': 'std::string', 'cconsttype': 'const char * const'}, {'value': 'Line0', 'srcline': 51, 'name': 'Line0', 'srcfile': 'Tutorials.cfg', 'description': '', 'type': 'str', 'ctype': 'std::string', 'cconsttype': 'const char * const'}, {'value': 'Line1', 'srcline': 52, 'name': 'Line1', 'srcfile': 'Tutorials.cfg', 'description': '', 'type': 'str', 'ctype': 'std::string', 'cconsttype': 'const char * const'}, {'value': 'Line1', 'srcline': 53, 'name': 'Line2', 'srcfile': 'Tutorials.cfg', 'description': '', 'type': 'str', 'ctype': 'std::string', 'cconsttype': 'const char * const'}, {'value': 'Line3', 'srcline': 54, 'name': 'LIne3', 'srcfile': 'Tutorials.cfg', 'description': '', 'type': 'str', 'ctype': 'std::string', 'cconsttype': 'const char * const'}], 'enum_description': 'An enum to set source'}"),
      ...
      rclcpp::parameter::ParameterVariant("edit.trigger_selector","{'enum': [{'value': 'AcquisitionStart', 'srcline': 57, 'name': 'AcquisitionStart', 'srcfile': 'Tutorials.cfg', 'description': '', 'type': 'str', 'ctype': 'std::string', 'cconsttype': 'const char * const'}, {'value': 'AcquisitionEnd', 'srcline': 58, 'name': 'AcquisitionEnd', 'srcfile': 'Tutorials.cfg', 'description': '', 'type': 'str', 'ctype': 'std::string', 'cconsttype': 'const char * const'}, {'value': 'AcquisitionActive', 'srcline': 59, 'name': 'AcquisitionActive', 'srcfile': 'Tutorials.cfg', 'description': '', 'type': 'str', 'ctype': 'std::string', 'cconsttype': 'const char * const'}, {'value': 'FrameStart', 'srcline': 60, 'name': 'FrameStart', 'srcfile': 'Tutorials.cfg', 'description': '', 'type': 'str', 'ctype': 'std::string', 'cconsttype': 'const char * const'}, {'value': 'FrameEnd', 'srcline': 61, 'name': 'FrameEnd', 'srcfile': 'Tutorials.cfg', 'description': '', 'type': 'str', 'ctype': 'std::string', 'cconsttype': 'const char * const'}, {'value': 'FrameActive', 'srcline': 62, 'name': 'FrameActive', 'srcfile': 'Tutorials.cfg', 'description': '', 'type': 'str', 'ctype': 'std::string', 'cconsttype': 'const char * const'}, {'value': 'FrameBurstStart', 'srcline': 63, 'name': 'FrameBurstStart', 'srcfile': 'Tutorials.cfg', 'description': '', 'type': 'str', 'ctype': 'std::string', 'cconsttype': 'const char * const'}, {'value': 'FrameBurstEnd', 'srcline': 64, 'name': 'FrameBurstEnd', 'srcfile': 'Tutorials.cfg', 'description': '', 'type': 'str', 'ctype': 'std::string', 'cconsttype': 'const char * const'}, {'value': 'FrameBurstActive', 'srcline': 65, 'name': 'FrameBurstActive', 'srcfile': 'Tutorials.cfg', 'description': '', 'type': 'str', 'ctype': 'std::string', 'cconsttype': 'const char * const'}, {'value': 'LineStart', 'srcline': 66, 'name': 'LineStart', 'srcfile': 'Tutorials.cfg', 'description': '', 'type': 'str', 'ctype': 'std::string', 'cconsttype': 'const char * const'}, {'value': 'ExposureStart', 'srcline': 67, 'name': 'ExposureStart', 'srcfile': 'Tutorials.cfg', 'description': '', 'type': 'str', 'ctype': 'std::string', 'cconsttype': 'const char * const'}, {'value': 'ExposureEnd', 'srcline': 68, 'name': 'ExposureEnd', 'srcfile': 'Tutorials.cfg', 'description': '', 'type': 'str', 'ctype': 'std::string', 'cconsttype': 'const char * const'}, {'value': 'ExposureActive', 'srcline': 69, 'name': 'ExposureActive', 'srcfile': 'Tutorials.cfg', 'description': '', 'type': 'str', 'ctype': 'std::string', 'cconsttype': 'const char * const'}], 'enum_description': 'An enum to set tirgger behavior'}"),
      ...
      rclcpp::parameter::ParameterVariant("edit.trigger_activation","{'enum': [{'value': 'RisingEdge', 'srcline': 72, 'name': 'RisingEdge', 'srcfile': 'Tutorials.cfg', 'description': '', 'type': 'str', 'ctype': 'std::string', 'cconsttype': 'const char * const'}, {'value': 'FallingEdge', 'srcline': 73, 'name': 'FallingEdge', 'srcfile': 'Tutorials.cfg', 'description': '', 'type': 'str', 'ctype': 'std::string', 'cconsttype': 'const char * const'}, {'value': 'AnyEdge', 'srcline': 74, 'name': 'AnyEdge', 'srcfile': 'Tutorials.cfg', 'description': '', 'type': 'str', 'ctype': 'std::string', 'cconsttype': 'const char * const'}, {'value': 'LevelHigh', 'srcline': 75, 'name': 'LevelHigh', 'srcfile': 'Tutorials.cfg', 'description': '', 'type': 'str', 'ctype': 'std::string', 'cconsttype': 'const char * const'}, {'value': 'LevelLow', 'srcline': 76, 'name': 'LevelLow', 'srcfile': 'Tutorials.cfg', 'description': '', 'type': 'str', 'ctype': 'std::string', 'cconsttype': 'const char * const'}], 'enum_description': 'An enum to set tirgger activation method'}"),
      ...
      rclcpp::parameter::ParameterVariant("edit.trigger_overlap","{'enum': [{'value': 'Off', 'srcline': 80, 'name': 'Off', 'srcfile': 'Tutorials.cfg', 'description': '', 'type': 'str', 'ctype': 'std::string', 'cconsttype': 'const char * const'}, {'value': 'ReadOut', 'srcline': 81, 'name': 'ReadOut', 'srcfile': 'Tutorials.cfg', 'description': '', 'type': 'str', 'ctype': 'std::string', 'cconsttype': 'const char * const'}, {'value': 'PreviousFrame', 'srcline': 82, 'name': 'PreviousFrame', 'srcfile': 'Tutorials.cfg', 'description': '', 'type': 'str', 'ctype': 'std::string', 'cconsttype': 'const char * const'}, {'value': 'PreviousLine', 'srcline': 83, 'name': 'PreviousLine', 'srcfile': 'Tutorials.cfg', 'description': '', 'type': 'str', 'ctype': 'std::string', 'cconsttype': 'const char * const'}], 'enum_description': 'An enum to set tirgger overlap method'}"),
      ...
      rclcpp::parameter::ParameterVariant("edit.awb_lightprofile","{'enum': [{'value': 'Indoor', 'srcline': 97, 'name': 'Indoor', 'srcfile': 'Tutorials.cfg', 'description': '', 'type': 'str', 'ctype': 'std::string', 'cconsttype': 'const char * const'}, {'value': 'Outdoor', 'srcline': 98, 'name': 'Outdoor', 'srcfile': 'Tutorials.cfg', 'description': '', 'type': 'str', 'ctype': 'std::string', 'cconsttype': 'const char * const'}], 'enum_description': 'An enum to set light profile'}"),
      ...
      rclcpp::parameter::ParameterVariant("edit.ae_lightmode","{'enum': [{'value': 'Normal', 'srcline': 101, 'name': 'Normal', 'srcfile': 'Tutorials.cfg', 'description': '', 'type': 'str', 'ctype': 'std::string', 'cconsttype': 'const char * const'}, {'value': 'Backlight', 'srcline': 102, 'name': 'Backlight', 'srcfile': 'Tutorials.cfg', 'description': '', 'type': 'str', 'ctype': 'std::string', 'cconsttype': 'const char * const'}, {'value': 'Frontlight', 'srcline': 103, 'name': 'Frontlight', 'srcfile': 'Tutorials.cfg', 'description': '', 'type': 'str', 'ctype': 'std::string', 'cconsttype': 'const char * const'}], 'enum_description': 'An enum to set auto exposure lighting mode setting'}"),
      ...
      rclcpp::parameter::ParameterVariant("edit.ae_priority","{'enum': [{'value': 'Gain', 'srcline': 118, 'name': 'Gain', 'srcfile': 'Tutorials.cfg', 'description': '', 'type': 'str', 'ctype': 'std::string', 'cconsttype': 'const char * const'}, {'value': 'ExposureTime', 'srcline': 119, 'name': 'ExposureTime', 'srcfile': 'Tutorials.cfg', 'description': '', 'type': 'str', 'ctype': 'std::string', 'cconsttype': 'const char * const'}], 'enum_description': 'An enum to set auto exposure control priority setting'}"),
